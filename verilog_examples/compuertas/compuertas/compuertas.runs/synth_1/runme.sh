...
HD_PWD='C:/Users/LENOVO/Desktop/DDA/verilog_tests/compuertas/compuertas/compuertas.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log compuertasLogicas.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source compuertasLogicas.tcl
